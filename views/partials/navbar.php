      ...
      <ul class="nav navbar-nav">
        ...
        <div>
          <form class="navbar-form navbar-right" role="signup">
            ...
            <button type="submit" class="btn btn-default">Join PokeDoption</button>
          </form>
        </div>
    </div>
    <div class="row">
        <div>
          <form class="navbar-form top navbar-right" role="login">
            <div class="form-group">
        ...
        <img class="img-responsive" src="volcanion.png">
        </div>
    </div>
