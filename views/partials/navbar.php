  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">My Pokemart<span class="caret"></span></a>
 		...
 		<li><a href="#"><i class="fa fa-2x fa-shopping-cart" aria-hidden="true"></i></a></li>
      </ul>
