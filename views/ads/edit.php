        ...
        <div class="col-sm-6 col-sm-offset-3">
            <form class="text-center">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $ad->title; ?>">
                </div>
                <div class="form-group">
                    <label for="price">Price</label>
                    <input type="number" class="form-control" value="<?= $ad->price; ?>">
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control" rows="5"><?= $ad->description; ?></textarea>
                </div>
                <div class="form-group">
