    ...
    <div class="container">
        ...
        <section id="login">
            ...
            <div class="row">
                ...
                <h1 class="section-title text-center">Login To OooLister</h1>
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <?php endif; ?>
                            <input type="text" class="form-control input-required" id="email_user" name="username" placeholder="Username" required>
                        </div>
                        <div class="form-group">
