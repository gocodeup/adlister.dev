...
$ad->description = 'Everything was used only part time and is relatively clean, from our smoke free, pet free home. (That\'s only kind of a lie- my brother used to smoke a ton of pot but as far as I know he only did it in his girlfriend\'s car. Also, we do have a turtle, but she was only on the booster chair one time and it was for a "turtle birthday party" which was my brother\'s bright idea and I\'m pretty sure he was baked AF that day, which is why it only happened that one time before I got home from work. I have thoroughly washed the booster chair since then.)';
$ad->price = 4.20;
$ad->user_id = 8;
$ad->save();
