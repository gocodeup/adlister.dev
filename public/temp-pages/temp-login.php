        ...
        <form method="POST" action="" data-validation data-required-message="This field is required">
          ...
          <div class="row">
            <div class="col s12 m8 l4 offset-m2 offset-l4">
              <a class="btn waves-effect waves-light" type="submit" name="action">Submit</a>
<!-- link needs to be added here to create user signup page -->
              <a href="/signup" class="btn btn-success">New User</a>
            </div>
          </div>
        </form>
    </div>
...
<<!-- div class="container">
  ...
  <section id="login">
    ...
    <div class="row"> -->
      ...
      <?php //if (isset($_SESSION['ERROR_MESSAGE'])) : ?>
                <!-- <div class="alert alert-danger"> -->
                    <!-- <p class="error"><?php //= //$_SESSION['ERROR_MESSAGE']; ?></p> -->
                <!-- </div> -->
                <?php //unset($_SESSION['ERROR_MESSAGE']); ?>
            <?php //endif; ?>
            <?php //if (isset($_SESSION['SUCCESS_MESSAGE'])) : ?>
                <!-- <div class="alert alert-success">
                    <p class="success"><?php //= //$_SESSION['SUCCESS_MESSAGE']; ?></p>
                </div> -->
                <?php //unset($_SESSION['SUCCESS_MESSAGE']); ?>
            <?php //endif; ?>
